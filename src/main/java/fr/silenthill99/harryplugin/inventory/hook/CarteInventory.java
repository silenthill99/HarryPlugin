...
public class CarteInventory extends AbstractInventory<CarteHolder> {
    ...
    public enum CarteDuMaraudeur
    {
        ...
        QUIDDITCH("Terrain de Quidditch", new Location(world, -1731.5, 83, 722.5, 0, 0)),
        ...
        BIBLIOTHEQUE("Bibliothèque", new Location(world, -1963.5, 134, 534.5, 90f, 0)),
        TOMBE("Tombe de Dumbledore", new Location(world, -2079.5, 55, 267.5, 45f, 0)),
        ESCALIERS("Grands escaliers", new Location(world, -1994.5, 130, 416.5, 0, 0)),
